...
.stringn "시구르드 님・・・・・・"
db NewLine
.stringn "제가 섬긴 분이 당신이라"
db NewLine
.stringn "후회없는 인생이었습니다"
db WaitForA
db EndText
...
dh LoadPortrait
dh 0x000E//Lex
.stringn "나도 사람이 너무 좋아서 탈이라니까"
db NewLine
.stringn "・・・시구르드 공자,"
db NewLine
.stringn "미안하지만 먼저 가서 기다리지・・・"
db WaitForA
db EndText
