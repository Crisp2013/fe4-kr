...
.stringn  "이 녀석이"
db NewLine
.stringn  "이젠 나를 늙은이 취급하는군"
db NewLine
.stringn  "그래도 아직은 젊은데 말이야"
...
.stringn  "사람들이 황태자님을 성전사로서"
db NewLine
.stringn  "추앙하고 있는 지금, 황태자님께서도"
db NewLine
