...
//Script:Units conversation Ch9-Ed
...
.stringn  "한니발 장군님이시죠?"
db NewLine
.stringn  "상호 간에 무의미한 싸움을"
db NewLine
.stringn  "하게 된 점을 깊이 사과드립니다"
...
.stringn  "응, 하나도 없어"
db NewLine
.stringn  "아빠가 다나의 거리에서 주워 왔을 때"
db NewLine
.stringn  "난 갓난아이였다고 했으니까・・・"
db WaitForA
...
.stringn  "아르테나 님 아니십니까"
db NewLine
.stringn  "사정은 들었습니다"
db NewLine
.stringn  "당신도 심정이 복잡하시겠군요"
...
.stringn  "한니발 장군님・・・"
db NewLine
.stringn  "장군님도 해방군에 계셨군요"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn  "다행입니다・・・"
db NewLine
.stringn  "당신까지 적이었으면 못 싸웠을 거예요"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn  "가능하면 장군님이 설득해 주실래요?"
db WaitForA

db Top_Slot// Hannibal
dh ScrollText_DBC
.stringn  "공주님이 실패했다면 방법은 없습니다"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn  "추한 모습을 보이기 싫으실 겁니다"
db NewLine
.stringn  "이해해 주시길・・・ 아르테나 공주님"
db WaitForA
db EndText
...
.stringn  "죄송해요, 세리스 님・・・"
db NewLine
.stringn  "자꾸 곤란하시게 만들고 마네요"

db Bottom_Slot// Seliph
dh PauseForTime
db 0x10
.stringn  "긴 여행이었으니 지친 걸 거야"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn  "이 전투가 끝나면"
db NewLine
.stringn  "밀레토스 쪽 자유 도시로 갈 테니까"
db NewLine
.stringn  "거기서 당분간 머무르면서 쉬자"
db WaitForA
db ScrollText

.stringn  "아, 그래"
db NewLine
.stringn  "둘이서 마을에서 쇼핑이라도 할까?"
db NewLine
.stringn  "율리아가 좋아하는 걸 사 줄게"
db WaitForA
db ScrollText
...
.stringn  "제가 할 수 있는 거라면"
db NewLine
.stringn  "뭐든 말씀해 주십시오"
db NewLine
.stringn  "누님의 힘이 되고 싶습니다"
...
.stringn  "아리온을 데려간 건"
db NewLine
.stringn  "율리우스 황자일 거예요・・・"
db NewLine
db WaitForA

db Top_Slot// Leif
dh ScrollText_DBC
.stringn  "제국의 율리우스 황자가요!?"
db NewLine
.stringn  "근데 대체 어째서죠?"
db NewLine
...
.stringn  "그야"
db NewLine
.stringn  "아리온이 죽어서 사라진 게 아니라면"
db NewLine
.stringn  "오히려 희망이 있다는 뜻이니까요"
db WaitForA
db ScrollText
...
db NewLine
.stringn  "시구르드 공과 디아도라 님의 아이야"
db NewLine
.stringn  "이제 나 따윈 상대도 안 되겠는걸"

db Bottom_Slot// Seliph
dh PauseForTime
db 0x10
.stringn  "이것도 샤난 덕분이지 뭘"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn  "어릴 때부터"
...
.stringn  "이봐 이봐"
db NewLine
.stringn  "날 늙은이 취급할 셈이야?"
db NewLine
.stringn  "이래 보여도 아직 젊다고"
...
.stringn  "생각해 보면 정말 그란벨 땅은"
db NewLine
.stringn  "한 번도 밟은 적이 없으십니다"
db NewLine
...
db Top_Slot// Oifey
dh ScrollText_DBC
.stringn  "황자님의 심중은 능히 이해합니다"
db NewLine
.stringn  "하지만 힘없는 사람들의 마음도"
db NewLine
.stringn  "헤아려 주시길 바랍니다"
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x10
.stringn  "그럼 만프로이가 로프토우스인가?"
db NewLine
db WaitForA

db Top_Slot// Oifey
dh ScrollText_DBC
.stringn  "황자님・・・ 아무튼 서두르셔야 합니다"
db NewLine
...
.stringn  "사람들이 황자님을 성전사로서"
db NewLine
.stringn  "추앙하고 있는 지금, 황자님께서도"
db NewLine
.stringn  "그 외침에 응하셔야 합니다"
db WaitForA
db EndText
...
.stringn  "나, 네가 자꾸 신경 쓰여서・・・"
db NewLine
.stringn  "그러다 보니 그만・・・ 미안해"
db NewLine

db Bottom_Slot// Patty
dh PauseForTime
db 0x10
.stringn  "신경 쓰인다는 게 무슨 말인데?"
db NewLine
db WaitForA
...
.stringn  "하지만 살아 계신다면"
db NewLine
.stringn  "왜 저를 만나러 오지 않는 거죠!?"
db WaitForA
db ScrollText

.stringn  "전 언제나 기다리고 있는데,"
db NewLine
.stringn  "외로워서 견딜 수가 없는데・・・"
db NewLine
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x10
.stringn  "네, 브룸 외숙부님의 부하가"
db NewLine
.stringn  "실레지아로 쳐들어와서"
db NewLine
.stringn  "저희를 억지로 끌고 갔어요"
db WaitForA
dh ScrollText_DBC
...
dh PauseForTime
db 0x10
.stringn  "그렇지・・・ 그래도 절대 무리하지 마"
db NewLine
.stringn  "너는 신트라키아 왕국의 왕비로서"
db NewLine
.stringn  "나를 도와줘야 하니까"
db WaitForA
dh ScrollText_DBC
.stringn  "이런 곳에서 죽어 버리면 곤란해"
db NewLine
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x10
.stringn  "나도 성전사의 힘만 물려받았더라면"
db NewLine
.stringn  "좀 더 활약할 수 있었을 텐데・・・"
db NewLine
.stringn  "제길, 못 해 먹겠네!"
db WaitForA
...
.stringn  "지금까지 모두 함께"
db NewLine
.stringn  "열심히 해 왔기도 하고"
db NewLine
db WaitForA
db ScrollText

.stringn  "우리에게도 평민으로서의 각오가"
db NewLine
.stringn  "있다는 걸 보여 줬으니 만족하자"
db NewLine
...
db Top_Slot// Muirne
dh ScrollText_DBC
.stringn  "그렇긴 하지만・・・ 그래도 기운 내!"
db NewLine
.stringn  "고향에는 네가 돌아오길 기다리는"
db NewLine
.stringn  "아이들이 많이 있으니까"
...
db Top_Slot// Larcei
.stringn  "응, 그래도 무리하진 마"
db NewLine
.stringn  "네겐 나라를 바로잡을 의무가 있으니까"
db NewLine
...
dh PauseForTime
db 0x10
.stringn  "하하하, 그리 무서운 표정 짓지 마"
db NewLine
.stringn  "예쁜 얼굴이 망가지잖아"
db NewLine
db WaitForA
...
dh PauseForTime
db 0x10
.stringn  "응, 그래도 여기까지 왔잖아"
db NewLine
.stringn  "조금만 더 힘내 보려고"
db NewLine
db WaitForA
...
.stringn  "네, 물론이죠"
db NewLine
.stringn  "당신과 함께 살아가기로 마음먹은걸요"
db NewLine
.stringn  "어머님 같은 실수는 하지 않겠어요"

db Bottom_Slot// Ares
dh PauseForTime
db 0x10
.stringn  "고모님은 우리 아버님 엘트샨을"
db NewLine
.stringn  "사랑하셨던 걸까? ・・・"
db NewLine
db WaitForA
...
dh PauseForTime
db 0x10
.stringn  "그러고 보니 우린 사촌이었지"
db NewLine
db WaitForA

db Top_Slot// Nanna
dh ScrollText_DBC
.stringn  "후훗, 더욱 이상할 건 없네요"
db NewLine
db WaitForA
db EndText
...
db NewLine
.stringn  "황자님을 위해 살아오다니"

db Bottom_Slot// Oifey
dh PauseForTime
db 0x10
.stringn  "음・・・ 우리들은 지난 전쟁에서"
db NewLine
...
dh PauseForTime
db 0x10
.stringn  "그렇게 서두를 것 없단다"
db NewLine
.stringn  "조금씩 어른이 되어 가면 돼"
db NewLine
db WaitForA
...
dh PauseForTime
db 0x10
.stringn  "게다가 코노트에 두고 온 애들한테"
db NewLine
.stringn  "돈도 보내 줘야 하고,"
db NewLine
.stringn  "나도 머리 아프단 말야"
db WaitForA
...
dh PauseForTime
db 0x10
.stringn  "하지만 브룸 외숙부님과"
db NewLine
.stringn  "이슈타르 언니, 이슈트 오라버니는"
db NewLine
.stringn  "엄청 나쁜 사람은 아니었어요"
db WaitForA
dh ScrollText_DBC
.stringn  "저와 어머님에겐 조금이나마"
db NewLine
.stringn  "잘해 주려 애쓰셨고요"
db NewLine
db WaitForA
...
dh PauseForTime
db 0x10
.stringn  "네, 저도 그 여자만큼은 용서가 안 돼요"
db NewLine
.stringn  "가능하다면"
db NewLine
.stringn  "제 손으로 죽이고 싶었어요・・・"
db WaitForA
...
dh PauseForTime
db 0x10
.stringn  "저기 오라버니, 어머님은"
db NewLine
.stringn  "어째서 고국을 버리고"
db NewLine
.stringn  "시구르드군에 가담하신 걸까요?"
db WaitForA
...
db NewLine
.stringn  "참을 수가 없어서 그만・・・"
db WaitForA
db ScrollText

.stringn  "세리스 님, 저도 해방군에"
db NewLine
.stringn  "참가시켜 주세요"
db NewLine
