...
dh PauseForTime
db 0x10
.stringn  "아버님・・・ 그 인간은 정말 이상해"
db NewLine
.stringn  "대체 무슨 생각을 하는 건지・・・"
db NewLine
db WaitForA
db EndText
...
db NewLine
.stringn  "렌스터의 외가에 맡기셨다고 했지"
db NewLine
db WaitForA
db ScrollText

.stringn  "하지만 그 렌스터도 머지않아"
db NewLine
.stringn  "그란벨에게 침략당해,"
db NewLine
.stringn  "어머님은 돌아가시고 말았지만・・・"
db WaitForA
db ScrollText
...
.stringn  "이제 아셨나요?"
db NewLine
.stringn  "엘트샨 전하께선 시구르드 님을"
db NewLine
.stringn  "마지막까지 신뢰하셨어요"
db WaitForA
db ScrollText

.stringn  "두 분께선 정말로 벗이셨던 거예요"
db NewLine
...
.stringn  "안녕, 세티"
db NewLine
.stringn  "이분은 레빈이야, 우리 군사셔"
db NewLine
db WaitForA

db Top_Slot// Ced
dh ScrollText_DBC
.stringn  "레빈・・・ 역시 아버님이셨군요・・・"
db NewLine
...
dh LoadPortrait
dh 0x0280//Lewyn
.stringn  "이런 세티, 들킨 모양이구나"
db NewLine
.stringn  "오랜만이군, 잘 지냈느냐?"
db NewLine
db WaitForA

db Top_Slot// Ced
dh ScrollText_DBC
.stringn  "잘 지냈느냐 같은 소린 집어치우시죠!!"
db NewLine
...
.stringn  "나라를 떠난 게"
db NewLine
.stringn  "이제 몇 년째인지 알고 계시냐고요!"
db NewLine

db Bottom_Slot// Lewyn
dh PauseForTime
db 0x10
.stringn  "그러고 보니 벌써 몇 년이나 됐군"
db NewLine
.stringn  "퓨리는 잘 지내느냐?"
db NewLine
db WaitForA
...
.stringn  "그래・・・ 퓨리가・・・"
db NewLine
.stringn  "그것참 불쌍하게 됐구나・・・"
db NewLine
db WaitForA

db Top_Slot// Ced
dh ScrollText_DBC
.stringn  "아버님, 정말 매정하시군요"
db NewLine
.stringn  "어머님의 부고를 듣고도"
db NewLine
...
db Top_Slot// Ced
dh ScrollText_DBC
.stringn  "피도 당신을 원망하고 있습니다"
db NewLine
.stringn  "절대 먼저 말을 걸지 않겠다고"
db NewLine
.stringn  "마음먹은 것 같더군요"
db WaitForA
db ScrollText
...
.stringn  "후훗, 부끄러워하긴"
db NewLine
.stringn  "귀여운 구석이 있다니까"
db NewLine
.stringn  "뭐, 그래서 좋아하는 거지만"

db Bottom_Slot
dh PauseForTime
db 0x20
.stringn  "저기, 이제 그만 좀 하지?"
db NewLine
dh PauseForTime
db 0x60
db EndText
