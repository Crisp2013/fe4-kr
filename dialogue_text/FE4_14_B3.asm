...
db Top_Slot// Finn
dh ScrollText_DBC
.stringn "・・・부끄러운 이야기다만, 네가"
db NewLine
.stringn "옛적에 사랑했던 사람과 너무 닮았구나"
db NewLine
...
db Top_Slot// Febail
.stringn "아니, 내가 잘못한 건 사실이야"
db NewLine
.stringn "제국에 빌붙다니"
db NewLine
.stringn "한심한 짓을 했다・・・ 부끄러워"
db WaitForA
db ScrollText

.stringn "세리스 황태자,"
db NewLine
.stringn "죄값은 확실하게 치러주지"
db NewLine
