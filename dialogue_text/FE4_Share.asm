...
.stringn  "응, 좋아!"
db NewLine
.stringn  "내 춤으로 기운이 생긴다면"
db NewLine
.stringn  "얼마든지 춰 줄 수 있어!"
db WaitForA
dh ScrollText_DBC
.stringn  "・・・그럼, 간다!!"
db NewLine
...
.stringn  "맞다, 너한테 좋은 물건을 줄게"
db NewLine
.stringn  "마법방어가 올라가는 성스러운 검이야"
db NewLine
...
db NewLine
.stringn  "마냐, 괜찮아? 더 날 수 있겠어?"
db WaitForA
db ScrollText

.stringn  "네겐 실레지아의 영웅이라 불리는"
db NewLine
.stringn  "이모님의 이름이 붙어 있잖아"
db NewLine
.stringn  "이 정도는 아무렇지도 않지?"
db WaitForA
db ScrollText
...
.stringn  "세리스 님도 그"
db NewLine
.stringn  "이슈타르라는 마도사를 보셨죠?"
db NewLine
.stringn  "그 사람, 순식간에 사라져 버렸어요"
db WaitForA
db ScrollText

.stringn  "우리로선 상상도 못할 정도로"
db NewLine
...
db NewLine
.stringn  "하지만 마나, 난 도망치지 않을 거야"
db WaitForA
db ScrollText

.stringn  "얼스터와"
db NewLine
.stringn  "코노트에 살던 사람들을 봤지?"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn  "모두 눈물을 흘리며 기뻐했어"
db NewLine
.stringn  "그만큼 제국의 지배가 가혹한 거야"
db WaitForA
db ScrollText

.stringn  "세상을 이대로 내버려 둘 순 없잖아?"
db NewLine
...
.stringn  "・・・세리스 님, 죄송해요"
db NewLine
.stringn  "걱정 끼쳤네요, 이제 괜찮아요"
db NewLine
.stringn  "저도 힘낼게요"
db WaitForA
db ScrollText

.stringn  "그래도 절대 무리하시면 안 돼요"
db NewLine
...
db NewLine
.stringn  "여자애들은 한 방이길래 그만"
db WaitForA
db ScrollText

.stringn  "이 방패 줄 테니까 봐주라!"
db NewLine
dh PauseForTime
db 0x1E
db ScrollText
...
.stringn  "그렇구나・・・"
db NewLine
.stringn  "같이 싸우면 좋았을 텐데・・・"
db NewLine
db WaitForA

db Top_Slot// Villager
dh ScrollText_DBC
.stringn  "뭐 어차피 난 슈터라서"
db NewLine
...
db Top_Slot// Villager
dh ScrollText_DBC
.stringn  "그럼 잘 있어, 힘내라구"
db NewLine
.stringn  "네게 나가의 가호가 있기를!"
db NewLine
db WaitForA
db EndText
...
db Top_Slot// Villager
dh ScrollText_DBC
.stringn  "그래! 너 해방군 사람이지?"
db NewLine
.stringn  "마을의 보물인 비전의 책과 약을 줄게!"
db NewLine
...
db NewLine
.stringn  "나도 거기 가세하고 있어"
db WaitForA
db ScrollText

.stringn  "아직 별로 도움은 안 되지만 말야"
db NewLine
...
db NewLine
.stringn  "이걸 차면 힘이 날 거야"
db NewLine
db WaitForA

db Top_Slot// Deimne
dh ScrollText_DBC
.stringn  "뭐? 그런 걸 어떻게 받아!"
db NewLine
...
.stringn  "괜찮아, 네가 가져가면"
db NewLine
.stringn  "엄마도 기뻐할 거야, 이 목걸이의 힘을"
db NewLine
.stringn  "발휘시킬 기회가 생겼다면서"
db WaitForA
dh ScrollText_DBC
.stringn  "・・・자, 머리 이리 줘"
db NewLine
...
.stringn  "하지만 어쩔 수 없다고"
db NewLine
.stringn  "난 전선에서 싸우고 싶단 말야!"
db NewLine
.stringn  "성의 수비는 이제 질색이야!"

db Bottom_Slot// Tristan
dh PauseForTime
db 0x10
.stringn  "넌 부탁하는 방법도 모르냐?"
db NewLine
.stringn  "그렇게 싫으면 난 안 할 거다"
db NewLine
db WaitForA
