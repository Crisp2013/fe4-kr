...
db NewLine
.stringn "이렇게 기다리는 것밖에 못해・・・"
db NewLine
db WaitForA
db ScrollText

.stringn "그래, 너한테 좋은 걸 줄게"
db NewLine
.stringn "마방이 올라가는 성스러운 검이야"
db NewLine
db WaitForA
db ScrollText
...
.stringn "혹시 괜찮다면"
db NewLine
.stringn "저녁이라도 같이 하지 않겠나?"
db NewLine
.stringn "저쪽에 맛있는 집이 있는데・・・"
...
db Top_Slot// Deimne
.stringn "응, 세리스 님이 제국에게서 세상을"
db NewLine
.stringn "해방하기 위해 군사를 일으키셨는데"
db NewLine
...
db Top_Slot// Deimne
dh ScrollText_DBC
.stringn "하하하, 그건 말 안하기로 했잖아"
db NewLine
.stringn "그래도 더욱 더 강해지려고"
db NewLine
.stringn "매일 노력하고 있어"
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x14
.stringn "우리들 좋아하네, 난 왜 끼워넣냐?"
db NewLine
.stringn "난데없이 헛소리 하지 마"
db NewLine
...
dh PauseForTime
db 0x0F
.stringn "생각만 하고 있다는 건"
db NewLine
.stringn "결국 내세울 게 없단 거잖아?"
...
.stringn "알겠어, 인정할게!"
db NewLine
.stringn "・・・그래서 난 왜 찾아온 거야?"
db NewLine
db WaitForA

db Top_Slot// Dalvin
dh ScrollText_DBC
.stringn "둘이서 검 수행 좀 하자"
db NewLine
dh PauseForTime
db 0x14
.stringn "나도 너같은 놈이랑"
...
.stringn "・・・너, 좋은 사람이구나・・・"
db NewLine
.stringn "남매가 둘 다 이렇게 착할 데가・・・"
db NewLine

db Bottom_Slot// Amid
dh PauseForTime
db 0x10
.stringn "힘들 때 돕고 사는거죠 뭐"
db NewLine
db WaitForA
