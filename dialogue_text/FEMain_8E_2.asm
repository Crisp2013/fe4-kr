...
.stringn  "그 포악함이 이루 비할 데가 없었다."
db NewLine
db WaitForA
db ScrollText

.stringn  "다난은 이자크인들을 노예 신분에 놓고"
db NewLine
.if _USE_OLD_TRANSLATION == 1
.stringn  "(빈줄)"
.endif
