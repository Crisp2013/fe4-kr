...
db NewLine
.stringn "우리 손으로 이루어 보아요"
dh PauseForTime
db 0x60
db ScrollText

.stringn "당신과 저 둘이서 손을 맞잡고"
db NewLine
.stringn "이 세상을 바르게 이끌고 싶어요"
db NewLine
