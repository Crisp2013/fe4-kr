...
dh PauseForTime
db 0x10
.stringn "뭐, 그렇지・・・ 하지만 나도 용병이야"
db NewLine
.stringn "명령받은 일은 해야 하거든・・・"
db NewLine
db WaitForA
db EndText
...
db NewLine
.stringn "마이오스 공께 보내는 선물로 말이야"
db NewLine

db Bottom_Slot// Erinys
dh PauseForTime
db 0x10
.stringn "그렇겐 안 될 걸, 디트바"
db NewLine
...
.stringn "훗,"
db NewLine
.stringn "울보 퓨리 주제에 잘난 척은!"
db NewLine
.stringn "웃길 생각이라면 그만두시지!"
db WaitForA
db EndText
...
db Top_Slot// Javarro
.stringn "아레스! 이 은혜도 모르는 놈!"
db NewLine
.stringn "이번엔 가만 두지 않겠다!"
db NewLine
...
dh PauseForTime
db 0x10
.stringn "브룸, 이 날만을 기다리고 있었다!"
db NewLine
.stringn "어머니와 동생을 빼앗아간 원한을"
db NewLine
.stringn "지금 깨닫게 해 주마!!"
db WaitForA
...
db NewLine
.stringn "더 이상 도망칠 수 없어, 그만 포기하시지"
db NewLine
db WaitForA
...
db NewLine
.stringn "내가・・・ 이 날이 오기만을"
db NewLine
.stringn "얼마나 간절히 기다려왔는지 모른다・・・"
db WaitForA
dh ScrollText_DBC
.stringn "네놈을 이 손으로 죽이는 것만을 꿈꾸며"
db NewLine
.stringn "지금까지 살아왔단 말이다!!"
db NewLine
db WaitForA
db ScrollText
...
.stringn "호호호,"
db NewLine
.stringn "그러고보니 넌 틸튜의 아들이었지?"
db NewLine
db WaitForA
db ScrollText

.stringn "그 여자는 내가 괴롭히다 죽여버렸는데,"
db NewLine
.stringn "복수를 하러 온 게냐?"
db NewLine
...
.stringn "가"
db NewLine
.stringn "산적 따윌 무서워할 리 없지"
dh PauseForTime
db 0x60
dh ScrollText_DBC
.stringn "미안해, 같이 가자"
db NewLine
.stringn "너가 있어주면 나도 든든해"
db NewLine
dh PauseForTime
db 0x60
db EndText
...
.stringn "네, 이런 인간을"
db NewLine
.stringn "내팽개쳐둘 순 없으니까요"
db NewLine
.stringn "제가 잘 지켜봐야죠 뭐"
