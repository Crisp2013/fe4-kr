...
db Top_Slot// Quan
.stringn "사과는 필요 없어, 에슬린"
db NewLine
.stringn "시구르드는 내게 있어서도 소중한 친구지"
db NewLine
db WaitForA
db ScrollText

.stringn "그리고 널 아내로 들인 지금"
db NewLine
.stringn "그는 내 처남이기도 해"
db NewLine
...
db Top_Slot// Munnir
dh ScrollText_DBC
.stringn "멍청한 놈, 부러운 표정 지을 필요 없어"
db NewLine
.stringn "그란벨을 점령하고 나면"
db NewLine
.stringn "너한테도 질릴 만큼 던져주지"
db WaitForA
db ScrollText
...
db Top_Slot// Munnir
dh ScrollText_DBC
.stringn "뭐라고 궁시렁대는 거야?"
db NewLine
.stringn "자, 가자! 꾸물대지 마라!!"
db NewLine
db WaitForA
db EndText
...
db NewLine
.stringn "우리 마을은 이제 살았어요"
db NewLine
db WaitForA
db ScrollText

.stringn "이 돈은 마을 사람들이 모은 겁니다"
db NewLine
.stringn "조금이지만 싸움에 보탬이 되면 좋겠네요"
db NewLine
db WaitForA
db ScrollText

.stringn "다른 마을도 구해주기만 한다면"
db NewLine
...
dh LoadPortrait
dh 0x02AB//Old villager
.stringn "잉그비는 활솜씨가 좋은 집안이지"
db NewLine
.stringn "공작가 사람들은 활의 신 울르의 자손이라네"
db NewLine
db WaitForA
db ScrollText
...
db Top_Slot// Arvis
dh ScrollText_DBC
.stringn "폐하께서 걱정하고 계신다"
db NewLine
.stringn "내게 지켜보고 오라고 명하시더군"
db NewLine
db WaitForA
db ScrollText
...
db Top_Slot// Arvis
dh ScrollText_DBC
.stringn "그걸 들으니 안심이 되는군"
db NewLine
.stringn "그럼 난 발할라로 돌아가겠네"
db NewLine
