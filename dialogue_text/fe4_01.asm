...
db Top_Slot// Sigurd
dh ScrollText_DBC
.stringn  "그래, 네가 이자크 왕의"
db NewLine
.stringn  "여동생이라고 샤난에게 들었다"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn  "목숨을 잃을 필요는 없어"
db NewLine

db Bottom_Slot// Ayra
dh PauseForTime
db 0x10
.stringn  "난 죽음을 결의한 오라버니로부터"
db NewLine
...
dh PauseForTime
db 0x10
.stringn  "아뇨, 전 그런 미신을 믿지 않습니다"
db NewLine
.stringn  "이야기를 들으니 너무 안쓰럽군요"
db NewLine
.stringn  "디아도라・・・ 다시 한번 만나고 싶어"
db WaitForA
db EndText
...
db NewLine
.stringn  "결코 악인이 아니라고 들었어"
db NewLine
.stringn  "더 이상 싸울 필요는 없다고"
...
dh LoadPortrait
dh 0x0052//Sandima
.stringn  "이것 참 자무카 왕자님"
db NewLine
.stringn  "말씀이 지나치신 것 아닙니까?"
db NewLine
db WaitForA
db ScrollText
...
.stringn  "산디마,"
db NewLine
.stringn  "네가 지금까지 말해 온 것은"
db NewLine
.stringn  "정말로 사실이겠지?"
db WaitForA
db ScrollText

.stringn  "넌 그란벨이 우리 나라를"
db NewLine
.stringn  "정복하려는 야심을 품었다고 했다만・・・"
db NewLine
...
db NewLine
.stringn  "암흑 마법을 쓰는 어둠의 사제입니다"
db NewLine
.stringn  "더 다가가면 분명 죽을 거예요"
db WaitForA
db ScrollText
...
.stringn  "그 산디마라는"
db NewLine
.stringn  "마도사가 오고 나서부터야"
db WaitForA
db ScrollText

.stringn  "아버지도 형님들도"
db NewLine
.stringn  "다들 놈의 꼭두각시가 되어 버렸어"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn  "지금쯤 어떻게 지내고 있을지"
db WaitForA
db ScrollText

.stringn  "살아 있다면 아마"
db NewLine
.stringn  "열일곱, 열여덟 정도일 텐데・・・"
db NewLine
db WaitForA
db EndText
