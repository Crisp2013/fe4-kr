...
db NewLine
.stringn  "이 나라는 오래가지 못해"
db NewLine
db WaitForA
db ScrollText

.stringn  "엘트샨 님께서 맹주가 되어주신다면"
db NewLine
.stringn  "더할 나위가 없을 텐데・・・"
db NewLine
db WaitForA
db EndText
