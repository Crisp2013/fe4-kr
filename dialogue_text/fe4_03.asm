...
db Top_Slot// Jacobi
dh ScrollText_DBC
.stringn  "알았다・・・ 내키진 않지만 돈을 받았으니,"
db NewLine
.stringn  "이 천둥의 검의 무서움을"
db NewLine
.stringn  "・・・놈들에게 가르쳐 주지"
...
.stringn  "・・・그래・・・ 알았다"
db NewLine
.stringn  "샤난, 네 잘못이 아니니 신경 쓰지 마라"
db NewLine
.if _USE_OLD_TRANSLATION == 1
db WaitForA
db ScrollText
.endif
.stringn  "내가 어떻게든 찾아보마"
.if _USE_OLD_TRANSLATION == 1
db NewLine
.stringn  "(빈줄)"
db NewLine
