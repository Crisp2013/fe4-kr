...
.stringn "아뢰옵건대 이는 역심을 품었음"
db NewLine
.stringn "외에 달리 판단할 도리가 없습니다"
db NewLine
db WaitForA
db ScrollText
...
db WaitForA
dh ScrollText_DBC
.stringn "나는 세리스를 잃고 싶지 않아"
db NewLine
.stringn "이 아이는 아직 두 살도 안 됐다"
db NewLine
...
.stringn "놈들을 이용할 대로 이용한 후"
db NewLine
.stringn "버리는 것이 본래의 계획"
db NewLine
.stringn "그 후엔 놈들의 아들을 이용해・・・"
db WaitForA
db ScrollText
...
.stringn "호호호・・・"
db NewLine
.stringn "그것도 디아도라 공 때문이겠지요"
db NewLine
.stringn "알비스 경께선 두려워하고 있어요"
db WaitForA
dh ScrollText_DBC
...
db NewLine
.stringn "성전사 노바의 피를 이은 용사의 나라다"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn "아버지는 이것이 정의를 위한 전쟁이라면"
db NewLine
.stringn "설령 멸망하더라도 후회는 없다고,"
db NewLine
.stringn "두려워하지 말고 싸우라고 말씀하셨어"
db WaitForA
db ScrollText
...
db NewLine
.stringn "알비스 님께서 손쓸 도리가 없으셨던 겁니다"
db NewLine
...
db Top_Slot// Aida
.stringn "예, 알비스 님께선 국왕 폐하와 함께"
db NewLine
.stringn "발할라에서 시구르드 님이 오시기만을"
db NewLine
.stringn "기다리고 계십니다"
db WaitForA
db ScrollText
...
db NewLine
.stringn "일부러 마중나와 주시다니 감사합니다"
db NewLine
.stringn "헌데, 폐하는 어디 계신지?"
db WaitForA
...
db WaitForA
dh ScrollText_DBC
.stringn "제 건에 대해서도 폐하께서"
db NewLine
.stringn "마음이 무거우셨을 겁니다"
db NewLine
db WaitForA
db ScrollText
...
db Top_Slot// Arvis
dh ScrollText_DBC
.stringn "경은 여기서 역적으로 죽는다"
db NewLine
.stringn "왕의 알현은 허락할 수 없어"
db NewLine
...
.stringn "무, 무슨・・・ 알비스 경,"
db NewLine
.stringn "이게 어떻게 된 겁니까!"
db NewLine
db WaitForA

db Top_Slot// Arvis
dh ScrollText_DBC
.stringn "후후후・・・ 이제야 눈치채다니,"
db NewLine
.stringn "귀공도 물러터졌군"
db NewLine
db WaitForA
