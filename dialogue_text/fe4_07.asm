...
db NewLine
.stringn "로프토 교단이 지배하고 있어"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn "암흑 마도사들이"
db NewLine
.stringn "지나가는 행인들을 습격하고 있지"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn "당분간 국경을 막고 상태를 지켜보자"
db NewLine
.stringn "놈들이 싸우다 지쳤을 때가 기회다"
db WaitForA
db ScrollText

.stringn "자바로의 용병 부대에게도"
db NewLine
.stringn "미리 준비해두라고 전해 둬라!"
db NewLine
db WaitForA
db EndText
...
.stringn "그럼 사람 죽이는 게 일이잖아"
db NewLine
db WaitForA
db ScrollText

.stringn "나도 기분 나쁜 사람들 앞에선"
db NewLine
.stringn "춤추고 싶지 않지만"
db NewLine
...
.stringn "그래, 인간의 선악이란"
db NewLine
.stringn "간단히 판단해선 안 되는 것이다"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn "날 때부터 악했던 사람은 없어"
db NewLine
.stringn "그걸 잊지 말아라・・・"
db NewLine
db WaitForA
...
.stringn "너희들의 무서움을"
db NewLine
.stringn "녀석들에게 보여 주어라!"
db NewLine

db Bottom_Slot// Banba
dh PauseForTime
db 0x10
.stringn "네, 맡겨만 주십시오, 브룸 님!"
db NewLine
db WaitForA
dh ScrollText_DBC
dh DialogClose
...
dh PauseForTime
db 0x10
.stringn "큭・・・ 그동안 신세 많이 졌다"
db NewLine
.stringn "하지만 그것도 여기까지야"
db NewLine
db WaitForA
dh ScrollText_DBC
...
db Top_Slot// Lene
.stringn "・・・나도 이제 고집부리지 않을게"
db NewLine
.stringn "그러니 아레스,"
db NewLine
.stringn "이제 아무데도 가지 말아 줘"
db WaitForA
db EndText
