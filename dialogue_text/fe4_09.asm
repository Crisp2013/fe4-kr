...
.stringn  "저를 봐 주십시오"
db NewLine
.stringn  "제가 말하는 바가 거짓인지,"
db NewLine
.stringn  "한눈에 아실 수 있을 것입니다"
db WaitForA
db ScrollText
