...
.stringn  "넌 여자면서도 무예가 뛰어나"
db NewLine
.stringn  "아리온과 함께 내 손과 발이 되어"
db NewLine
.stringn  "활약해 줄 거라 기대하고 있었다"
db WaitForA
db ScrollText
...
.stringn  "닥쳐라, 아르테나"
db NewLine
.stringn  "넌 말을 꺼낼 자격도 없다"
db NewLine
.stringn  "지금은 잠자코 아버님의 명령에 따라라!"
db WaitForA
db ScrollText
...
.stringn  "훗, 피는 무섭구나・・・"
db NewLine
.stringn  "저 녀석은 날 싫어하고 있어・・・"
db NewLine

db Bottom_Slot// Arion
dh PauseForTime
db 0x10
.stringn  "아버님, 아르테나는 아직 애입니다"
db NewLine
.stringn  "아버님께 응석을 부리다"
db NewLine
.stringn  "감정이 섞여 미움받을 말을・・・"
db WaitForA

db Top_Slot// Travant
dh ScrollText_DBC
.stringn  "됐다・・・ 난 카파토기아성에 다녀오마"
db NewLine
.stringn  "한니발 놈이"
db NewLine
.stringn  "내 방식에 불만을 품은 모양이더군"
db WaitForA
db ScrollText

.stringn  "놈이 배신하지 못하도록"
db NewLine
.stringn  "미리 손을 써 둬야겠지"
db NewLine
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x20
.stringn  "・・・아버님이 초조해하고 계시군・・・"
db NewLine
.stringn  "대체 어찌해야 한단 말인가・・・"
db NewLine
db WaitForA
db EndText
...
db NewLine
.stringn  "성의 수비에 빈틈은 없겠지?"
db NewLine

db Bottom_Slot// Distler
dh PauseForTime
db 0x10
.stringn  "트라반트 폐하 아니십니까"
db NewLine
.stringn  "잘 방문해 주셨습니다"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn  "루테키아성은 만전의 태세를 갖췄으니"
db NewLine
.stringn  "안심해 주십시오"
db NewLine
db WaitForA
...
.stringn  "알비스 황제는"
db NewLine
.stringn  "원군을 보내 주는 거겠지?"

db Bottom_Slot// Judah
dh PauseForTime
db 0x10
.stringn  "트라반트 님께선 의심도 많으시군요"
db NewLine
.stringn  "걱정 마십시오, 이미 제국 기사단이"
db NewLine
.stringn  "트라키아로 오고 있습니다"
db WaitForA
...
db Top_Slot// Lewyn
.stringn  "트라키아에서 용기사단이 출격했다"
db NewLine
.stringn  "드디어구나 세리스, 방심하지 마라"
db NewLine
...
.stringn  "전쟁은 이미 시작됐다"
db NewLine
.stringn  "이제 와서 돌이킬 수는 없어"
db NewLine

db Bottom_Slot// Seliph
dh PauseForTime
db 0x10
.stringn  "하지만, 먼스터의 산에서"
db NewLine
.stringn  "우리를 지켜보던 그 용기사는・・・"
db NewLine
.stringn  "무척 슬퍼 보였어요"
db WaitForA
dh ScrollText_DBC
...
dh LoadPortrait
dh 0x0019//Seliph
.stringn  "오이페, 레빈의 말이 맞아"
db NewLine
.stringn  "내가 잘못 생각하고 있었어"
db NewLine
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x10
.stringn  "아뇨, 그렇지는 않을 겁니다"
db NewLine
.stringn  "땅의 신 노바의 피는 큐안 님으로부터"
db NewLine
.stringn  "아르테나 님께 계승됐지요"
db WaitForA
dh ScrollText_DBC
.stringn  "지금 게이볼그를 쓸 수 있는 사람은"
db NewLine
.stringn  "아르테나 님밖에 없습니다"
db NewLine
db WaitForA
db ScrollText

.stringn  "트라반트는 그 힘을 원했을 뿐이죠"
db NewLine
.stringn  "그 사내가 생각할 법한 일입니다"
db NewLine
db WaitForA
db ScrollText
...
db Top_Slot// Hannibal
dh ScrollText_DBC
.stringn  "아니 잠깐, 성의 수비에 집중해라"
db NewLine
.stringn  "쓸데없이 싸울 필요는 없다"
db NewLine
...
db Top_Slot// Hannibal
dh ScrollText_DBC
.stringn  "아들이 위험한 건 알고 있다"
db NewLine
.stringn  "・・・・・하지만,"
db NewLine
.stringn  "・・・일단은 상황을 지켜보도록 하지"
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x10
.stringn  "디슬라 아저씨, 저 좀 풀어 주세요"
db NewLine
.stringn  "아빠는 싸울 생각이 없어요"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn  "저를 위해"
...
.stringn  "놈도 트라키아의 방패라 불린 무인이다"
db NewLine
.stringn  "이제 와서 도망친다니 말도 안 되지"
db NewLine
.stringn  "마지막까지 우리와 함께 싸워야 해!"
...
dh PauseForTime
db 0x10
.stringn  "누님이라고!? ・・・네놈은 누구냐!"
db NewLine
.stringn  "어째서 날 네 누이라 부르는 거지!"
db NewLine
db WaitForA
...
.stringn  "당신은 제 부모님이신"
db NewLine
.stringn  "큐안과 에슬린의 아이입니다"
db NewLine
.stringn  "17년 전, 두 분은 트라반트에게 죽었고"
db WaitForA
db ScrollText
...
.stringn  "그리고 당신이 들고 있는 그 창,"
db NewLine
.stringn  "그게 바로"
db NewLine
.stringn  "렌스터가의 무기 게이볼그입니다"
...
.stringn  "저를 봐 주십시오"
db NewLine
.stringn  "제가 말하는 바가 거짓인지 아닌지,"
db NewLine
.stringn  "보면 아실 수 있을 겁니다"
db WaitForA
db ScrollText
...
db Top_Slot// Travant
.stringn  "아르테나, 대체 무슨 생각이냐?"
db NewLine
.stringn  "또다시 부하들을 전장에 버려 놓고"
db NewLine
.stringn  "혼자서 도망쳐 오다니!"
...
dh PauseForTime
db 0x10
.stringn  "아버님! 듣고 싶은 것이 있습니다"
db NewLine
.stringn  "제가 아버님의 친딸이 아니라는 게"
db NewLine
.stringn  "사실입니까?"
db WaitForA
dh ScrollText_DBC
...
db NewLine
.stringn  "아무도 절 막을 권리는 없어요!"
db WaitForA

db Top_Slot// Arion
dh ScrollText_DBC
.stringn  "돌아가시게 놔둘 것 같아!"
db NewLine
.stringn  "아버님께 칼을 겨누겠다면,"
db NewLine
...
db Top_Slot// Arion
dh ScrollText_DBC
.stringn  "듣지 않는 게 나을 거다"
db NewLine
.stringn  "넌・・・ 아버님의 마음을 모를 테니까・・・"
db NewLine
...
.stringn  "오라버니, 휴전해요"
db NewLine
.stringn  "트라반트 왕이 죽었다면"
db NewLine
.stringn  "이제 방해할 사람도 없을 겁니다"
db WaitForA
dh ScrollText_DBC
...
db Top_Slot// Arion
.stringn  "아버님의 마지막 말씀을 듣지 않았다면"
db NewLine
.stringn  "나도 그렇게 했을 거다・・・"
db NewLine
.stringn  "이제 됐다 아르테나, 가라!"
db WaitForA
db ScrollText

.stringn  "다음에 만날 곳은 전장이다"
db NewLine
...
.stringn  "그래"
db NewLine
.stringn  "트라반트 폐하도 출진하셨다고・・・"
db NewLine
.stringn  "나도 무인이니 이젠・・・ 어쩔 수 없군・・・"
db WaitForA
db ScrollText

.stringn  "전군 돌격하라, 침략자들을 몰아내라!"
db NewLine
db WaitForA
db EndText
...
db NewLine
.stringn  "더는 당신들과 싸울 수 없게 됐습니다"
db NewLine
.stringn  "부디 저를 해방군에 넣어 주십시오"
...
db Top_Slot// Altena
.stringn  "오라버니에겐 지창 게이볼그를"
db NewLine
.stringn  "자신을 위해 쓰고 싶다고"
db NewLine
.stringn  "말한 적이 있는 모양입니다"
db WaitForA
db ScrollText
...
db Top_Slot// Altena
dh ScrollText_DBC
.stringn  "세리스 님, 부탁이 있습니다"
db NewLine
.stringn  "아리온은・・・ 아리온 왕자만큼은"
db NewLine
.stringn  "살려 주십시오"
...
db NewLine
.stringn  "저도 싸우고 싶지 않습니다"
db NewLine
.stringn  "하지만 그가 과연 항복할까요?"
db WaitForA

db Top_Slot// Altena
dh ScrollText_DBC
.stringn  "제가 다시 한번 설득해 보겠습니다"
db NewLine
...
dh LoadPortrait
dh 0x0267//Judah
.stringn  "카파토기아가 적의 손에 들어가!?"
db NewLine
.stringn  "흥, 트라키아 놈들은 머저리들뿐이군!"
db NewLine
db WaitForA
db ScrollText
...
.stringn  "세리스, 이젠 어쩔 수가 없다"
db NewLine
.stringn  "최후의 결전밖에 방법이 없어"
db NewLine
db WaitForA
db ScrollText
...
dh LoadPortrait
dh 0x025B//Arion
.stringn  "적이 드디어 그루티아에 도착했구나"
db NewLine
.stringn  "좋아, 「삼두의 용」 작전을 결행한다"
db NewLine
.stringn  "남아 있는 용기사단을 모두 투입하라"
db WaitForA
db ScrollText
...
.stringn  "그래"
db NewLine
.stringn  "율리우스 황자의 모습이 목격됐다"
db NewLine
.stringn  "아마 그가 탈출시켜 데려간 거겠지"
db WaitForA

db Top_Slot// Seliph
dh ScrollText_DBC
.stringn  "율리우스? 알비스 황제의 아들이요?"
db NewLine

db Bottom_Slot// Lewyn
dh PauseForTime
db 0x10
.stringn  "그래, 그리고 네 이부동생이지"
db NewLine
db WaitForA
...
dh PauseForTime
db 0x10
.stringn  "그래・・・ 황녀 디아도라 님이시다"
db NewLine
.stringn  "율리우스 황자는 어머니로부터"
db NewLine
.stringn  "샤먼으로서의 힘을 물려받았지"
db WaitForA
dh ScrollText_DBC
.stringn  "그래서 리턴도 리커버도"
db NewLine
.stringn  "마음대로 사용할 수 있다"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn  "정말 착한 아이들이라네"
db WaitForA
db ScrollText

.stringn  "둘은 어릴 때부터 사이가 좋았지"
db NewLine
.stringn  "앞으로도 쭉 그러면 좋을 텐데・・・"
db NewLine
db WaitForA
db EndText
...
db NewLine
.stringn  "십수 년 전 고아를 하나 거두셨어요"
db WaitForA
db ScrollText

.stringn  "그 후로 쭉 친아들처럼 키우고 계시죠"
db NewLine
...
.stringn  "소문을 들었는데"
db NewLine
.stringn  "제국에서 원군이 오고 있나 봐"
db NewLine
db WaitForA
db ScrollText

.stringn  "지휘관은 무서라고 하는데"
db NewLine
...
.stringn  "하하하,"
db NewLine
.stringn  "반란군의 조무래기 놈들"
db NewLine
.stringn  "내가 바로 트라반트다"
db WaitForA
db ScrollText

.stringn  "황천길 선물로 생각하고"
db NewLine
.stringn  "잘 기억해 두거라!"
db NewLine
db WaitForA
