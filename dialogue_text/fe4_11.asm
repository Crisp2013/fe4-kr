...
.stringn  "저는 이해가 안 갑니다"
db NewLine
.stringn  "실레지아에는 아버님이 필요해요"
db NewLine
dh PauseForTime
db 0x60
dh ScrollText_DBC
...
.stringn  " 녀석을 잘 부탁한다"
db NewLine
.stringn  "난 돌아가지 않을 거다"
db NewLine
.stringn  "실레지아는 너희 둘이 다스리도록 해"
dh PauseForTime
db 0x20
...
db NewLine
.stringn  "이제 전쟁은 끝났습니다"
db NewLine
.stringn  "함께 고국으로 돌아가셔야죠!!"
dh PauseForTime
db 0x60
...
.stringn  "네, 아버님은 제 자랑이십니다"
db NewLine
.stringn  "저도 빨리 아버님 같은 사람이"
db NewLine
.stringn  "될 수 있도록 노력하겠습니다"
dh PauseForTime
db 0x60
db EndText
