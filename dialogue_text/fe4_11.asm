...
db Top_Slot// Julius
dh ScrollText_DBC
.stringn "훗, 아버지도 가련하구나"
db NewLine
.stringn "네놈에게 이용당할 대로 이용당하고"
db NewLine
.stringn "쓸모가 없어지니 가차없이 버림받는가"

db Bottom_Slot// Manfroi
dh PauseForTime
db 0x10
.stringn "모두 전하를 위한 일입니다"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn "알비스 경은"
...
db Top_Slot// Julius
.stringn "나도 안다, 그건 그렇고"
db NewLine
.stringn "반란군이 시알피까지 들어왔다던데"
db NewLine
.stringn "제도의 방비는 문제 없겠지?"

db Bottom_Slot// Manfroi
dh PauseForTime
db 0x10
.stringn "안심하십시오, 시알피의 탈환을"
db NewLine
.stringn "에다의 로단 사제와 도즐의"
db NewLine
.stringn "브리앙 공자에게 명해 두었습니다"
db WaitForA
dh ScrollText_DBC
...
dh PauseForTime
db 0x10
.stringn "별채에 가둬 두었습니다"
db NewLine
.stringn "누가 가서 율리아 황녀를 데려와라!"
db NewLine
db WaitForA
dh ScrollText_DBC
dh DialogClose
...
dh LoadPortrait
dh 0x026C//Manfroi
.stringn "잠시만 기다리시지요, 율리우스 님"
db NewLine
.stringn "이 여자는 아직 쓸모가 있습니다"
db NewLine
.stringn "뒷일은 제게 맡겨 주십시오"
db WaitForA
...
.stringn "레빈,"
db NewLine
.stringn "당신은 정말 모든 걸 알고 계시네요"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn "이야기해 주세요"
db NewLine
.stringn "이게 다 어떻게 된 일이죠?"
db NewLine
db WaitForA
db ScrollText
...
db NewLine
.stringn "세상을 여행했다고 한다"
db WaitForA
db ScrollText

.stringn "그 목적은 전설에 나온"
db NewLine
...
.stringn "인간의 몸으로 닿을 수 없는"
db NewLine
.stringn "가공할 힘을 손에 넣는 것이었지"
db NewLine
...
.stringn "갈레 사교에겐"
db NewLine
.stringn "불가사의한 힘이 서려 있었다"
db WaitForA
db ScrollText

.stringn "본래가 야심가였던 갈레는"
db NewLine
.stringn "그 힘으로 젊은이들을 감화시키고"
db NewLine
db WaitForA
db ScrollText
...
db Top_Slot// Lewyn
dh ScrollText_DBC
.stringn "아마 고대 용족 중 한 명일 게다"
db NewLine
.stringn "그리고 갈레의 자손들에겐"
db NewLine
.stringn "그 용의 피가 이어지고 있어"
db WaitForA
db ScrollText

.stringn "로프토 일족의 사악한 힘은"
db NewLine
.stringn "용족의 힘이나 다름없는 셈이지"
db NewLine

db Bottom_Slot// Seliph
dh PauseForTime
db 0x10
.stringn "그럼, 우리 선조인 성전사들은・・・"
db NewLine
db WaitForA
...
.stringn "네・・・ 클로드 님도"
db NewLine
.stringn "아버지를 돕다 돌아가셨죠"
db NewLine
.stringn "하지만 신부님의 아이는・・・"
db WaitForA
db EndText
...
db Top_Slot// Lewyn
.stringn "도즐 집안도 성전사의 일원인데"
db NewLine
.stringn "참으로 꼴사납게 되었구나"
db NewLine
db WaitForA
db ScrollText
...
.stringn "이것도 모두"
db NewLine
.stringn "그 랑고바르트 경의 책임이겠지・・・"
db NewLine

db Bottom_Slot// Seliph
dh PauseForTime
db 0x10
.stringn "그럼 레빈, 성전사의 힘은"
db NewLine
.stringn "누구에게서 온 것이죠?"
db NewLine
.stringn "신들이란 대체・・・"
...
.stringn "정확히는 모르겠지만"
db NewLine
.stringn "이 대륙의 혼란이 용족의 힘으로"
db NewLine
.stringn "말미암았다는 것을 안 누군가가"
db WaitForA
db ScrollText

.stringn "우리들을 구원하기 위해"
db NewLine
.stringn "다른 세상에서 찾아온 모양이다"
db NewLine
db WaitForA
db ScrollText
...
.stringn "성전에서 말하는"
db NewLine
.stringn "나가와 열한 명 신의 강림이군요"
db NewLine
db WaitForA

db Top_Slot// Lewyn
dh ScrollText_DBC
.stringn "신들은 인간으로 모습을 바꾸었지"
db NewLine
.stringn "빛의 신 나가는 어린 소녀"
db NewLine
.stringn "불꽃의 신 샐러맨드는 노인으로"
db WaitForA
db ScrollText

.stringn "그리고 선택받은 열두 전사와"
db NewLine
.stringn "피의 맹약을 맺었다"
db NewLine
...
db NewLine
.stringn "성전사로 다시 태어났다"
db WaitForA
db ScrollText

.stringn "용족들은 성전사들에게"
db NewLine
.stringn "자신들의 힘을 봉인한 무기를 주었지"
db NewLine
db WaitForA
db ScrollText
...
db Top_Slot// Lewyn
dh ScrollText_DBC
.stringn "상당히 어려울 것 같구나"
db NewLine
.stringn "모두가 협력하면 어떻게 되겠지만"
db NewLine
.stringn "일단 나가의 힘을 얻는 게 최우선이다"
db WaitForA
db ScrollText
...
.stringn "하지만 제1황태자 세리스도"
db NewLine
.stringn "제2황태자 율리우스도"
db NewLine
.stringn "나가의 피가 발현되지 못했어"
db WaitForA
db ScrollText

.stringn "발현된 건 율리우스의 쌍둥이 동생・・・"
db NewLine
.stringn "율리아 황녀뿐이란 걸 최근에 알았다"
db NewLine
...
db Top_Slot// Lewyn
dh ScrollText_DBC
.stringn "율리아가 잡혀간 수수께끼도 풀렸다"
db NewLine
.stringn "세리스, 어떻게 해서든"
db NewLine
.stringn "율리아를 구해내야만 한다"
db WaitForA
db ScrollText

.stringn "율리우스와 싸우기 위해선"
db NewLine
.stringn "율리아의 힘이 반드시 필요하다!!"
db NewLine
db WaitForA
db EndText
...
.stringn "흥, 이놈이고 저놈이고"
db NewLine
.stringn "쓸모없는 녀석들 뿐이라니까"
db NewLine
.stringn "이제 됐어, 내가 나서야지 원"
db WaitForA
db ScrollText

.stringn "반란군을 이 성까지 끌어들여"
db NewLine
.stringn "단번에 승부를 내어주지"
db NewLine
db WaitForA
db ScrollText
...
.stringn "레빈,"
db NewLine
.stringn "드디어 프리지까지 왔어"
db NewLine
db WaitForA
db ScrollText

.stringn "하지만 발할라에 끌려간 아이들은"
db NewLine
.stringn "괜찮을까?"
db NewLine
.stringn "무사하다면 좋을 텐데・・・"
...
dh PauseForTime
db 0x10
.stringn "저는 알비스 폐하의 측근이었던"
db NewLine
.stringn "펠리페라고 합니다"
db NewLine
db WaitForA
dh ScrollText_DBC
.stringn "사실 폐하의 밀명을 받고"
db NewLine
.stringn "붙잡혀온 아이들을"
db NewLine
.stringn "이 프리지에서 보호하고 있었습니다"
db WaitForA
db ScrollText
...
.stringn "음, 여기에도 없다면"
db NewLine
.stringn "남은 건 제도 발할라나"
db NewLine
.stringn "벨트머 둘 중 하나겠지"
db WaitForA

db Top_Slot// Seliph
dh ScrollText_DBC
.stringn "발할라엔 율리우스가 있고・・・"
db NewLine
...
dh LoadPortrait
dh 0x026F//Julius
.stringn "단숨에 적을 쓸어버리도록 할까"
db NewLine
.stringn "십이마장이여, 너희가 나설 때다"
db NewLine
.stringn "아리온의 용병 부대도 출격을 명한다"
db WaitForA
db ScrollText

.stringn "여흥은 끝이다"
db NewLine
.stringn "총력을 동원해 역적들을 말살해라!!"
db NewLine
db WaitForA
db EndText
...
dh PauseForTime
db 0x10
.stringn "아뇨, 오히려 잘 됐어요"
db NewLine
.stringn "저, 제가 지금까지 살아온 의미를"
db NewLine
.stringn "처음으로 깨달았는걸요"
db WaitForA
dh ScrollText_DBC
...
db NewLine
.stringn "소중한 것에선 눈을 피하고 있어"

db Bottom_Slot// Arion
dh PauseForTime
db 0x10
.stringn "그럼 내가 뭘 할 수 있단 말이냐?"
db NewLine
db WaitForA
...
db NewLine
.stringn "도저히 이해해줄 수 없다면"
db NewLine
.stringn "나를 죽이고 가세요"
db WaitForA
db ScrollText

.stringn "난・・・ 오라버니의 손에 죽는다면"
db NewLine
.stringn "・・・후회는 없으니까"
db NewLine
...
.stringn "그래, 알비스 황제가"
db NewLine
.stringn "발할라 왕궁에서 빼내어"
db NewLine
.stringn "여기에 감췄다고 들었다"
db WaitForA
dh ScrollText_DBC
.stringn "그렇지? 펠리페 공"
db NewLine
...
dh PauseForTime
db 0x46
.stringn "역시 열리는군・・・ 아, 있다!"
db NewLine
.stringn "분명 나가의 성서가 틀림없어!"
db NewLine
.stringn "율리아, 받아라!"
dh BGMFade
db 0xE0
...
dh LoadPortrait
dh 0x01B8//Brian
.stringn "감히 내 아버지를 죽였겠다!"
db NewLine
.stringn "도즐 가문 3대에 거린 원한을"
db NewLine
.stringn "깨닫거라!"
db WaitForA
db EndText
...
dh LoadPortrait
dh 0x0271//Ishtar
.stringn "더 이상 할 말은 없어・・・"
db NewLine
.stringn "네놈에게 보여주마,"
db NewLine
.stringn "뇌신 이슈타르의 마지막 싸움을!"
db WaitForA
db EndText
...
.stringn "운명에 농락당한 가여우신 분이야"
db NewLine
.stringn "정중히 장례를 치러줬으면 해"
db NewLine
