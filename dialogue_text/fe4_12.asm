...
dh PauseForTime
db 0x10
.stringn "고맙긴 하지만・・・ 형님 되시는"
db NewLine
.stringn "알비스 경께선 이 일을 아니?"
db NewLine
db WaitForA
...
dh PauseForTime
db 0x10
.stringn "하하, 변함없이 입이 험한 놈이군"
db NewLine
.stringn "하지만 아버님 랑고바르트 경은"
db NewLine
.stringn "이 일을 아시나?"
db WaitForA
...
.stringn "시알피를 돕는 걸"
db NewLine
.stringn "허락해줄 리가 없잖아요?"
db NewLine
.stringn "제가 멋대로 온 거죠 뭐"
db WaitForA
db ScrollText

.stringn "오해할 것 같으니 덧붙이자면"
db NewLine
.stringn "절대 당신 도우러 온 거 아닙니다"
db NewLine
...
db Top_Slot// Lex
dh ScrollText_DBC
.stringn "・・・뭐, 요령은 안 피우렵니다"
db NewLine
.stringn "베르던 야만족들이 설치는 게"
db NewLine
.stringn "꼴보기 싫은 건 피차일반이니까"
db WaitForA
db EndText
...
db Top_Slot// Quan
dh ScrollText_DBC
.stringn "베르던과 싸운다고 들으니"
db NewLine
.stringn "가만히 앉아있을 수 없더군"
db NewLine
.stringn "나도 당분간 협력하마"
...
.stringn "그렇지"
db NewLine
.stringn "덕분에 핀밖에 데려올 수 없었다"
db NewLine
.stringn "내 랜스리터는 아버지께 맡겼고"
...
.stringn "시구르드, 잊지 마라"
db NewLine
.stringn "너를 이런 싸움에서 잃을 순 없어"
db NewLine
.stringn "그건 내가 허락 못 해"
db WaitForA
db EndText
...
dh PauseForTime
db 0x10
.stringn "서로 맘고생이 심하겠지만・・・"
db NewLine
.stringn "미데일, 지금은"
db NewLine
.stringn "에딘을 구하는 데만 집중하자"
db WaitForA
...
db NewLine
.stringn "해봤자 전혀 기뻐하지 않으실걸"
db WaitForA
db ScrollText

.stringn "그분께 충성을 다하고 싶다면"
db NewLine
.stringn "우선 살아남아야지 않겠냐?"
db NewLine
db WaitForA
db ScrollText
...
.stringn "저도 모르게 달려오고 말았습니다"
db NewLine

db Bottom_Slot// Edain
dh PauseForTime
db 0x10
.stringn "하지만, 당신의 형님께선"
db NewLine
.stringn "벨트머의 알비스 경이 아니신가요?"
db NewLine
.stringn "윤허가 있으셨나요?"
db WaitForA
...
db WaitForA
dh ScrollText_DBC
.stringn "일부러 옆나라까지 와서"
db NewLine
.stringn "전쟁도 다 하고,"
db NewLine
.stringn "어지간히 할 일이 없나보군"
db WaitForA
db ScrollText
...
db WaitForA
dh ScrollText_DBC
.stringn "누구에게도 보여주지 않은"
db NewLine
.stringn "특별한 춤, 조금 부끄럽지만"
db NewLine
.stringn "알렉이라면 보여줄 수 있어"
db WaitForA
db ScrollText
