...
dh PauseForTime
db 0x10
.stringn  "고맙긴 하지만・・・ 형님이신"
db NewLine
.stringn  "알비스 경께서는 이 일을 아니?"
db NewLine
db WaitForA
...
.stringn  "그렇지"
db NewLine
.stringn  "그래서 내 랜스리터는 아버지께"
db NewLine
.stringn  "맡기고 핀만 데려온 거다"
