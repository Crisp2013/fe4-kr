...
.stringn  "난 바쁜 몸이다,"
db NewLine
.stringn  "용건이 없다면 이만 가지"
db NewLine
db WaitForA

db Top_Slot// Lex
dh ScrollText_DBC
.stringn  "기다려, 좋은 걸 얻어서"
db NewLine
.stringn  "너한테 주려고 했단 말야"
db NewLine

db Bottom_Slot// Ayra
dh PauseForTime
db 0x10
.stringn  "선물 같은 건 다른 여자한테 해라"
db NewLine
...
.stringn  "그렇군요,"
db NewLine
.stringn  "역시 모든 게 렙토르의 소행・・・"
db NewLine
db WaitForA

db Top_Slot// Claud
dh ScrollText_DBC
.stringn  "아뇨, 그의 야망만이 아닐 겁니다"
db NewLine
.stringn  "그 배후엔 실로 무서운 존재가"
db NewLine
.stringn  "꿈틀거리고 있는 것 같더군요"
db WaitForA
db ScrollText
...
db NewLine
.stringn  "진실을 국왕 폐하께 고하겠습니다"
db NewLine
db WaitForA
db ScrollText

.stringn  "시구르드 공은 기다려 주세요"
db NewLine
...
.stringn  "에슬린? 우는 거야?"
db NewLine
.stringn  "뭔가 나쁜 예감이라도 들어서 그래?"
db NewLine
db WaitForA

db Top_Slot// Ethlyn
dh ScrollText_DBC
.stringn  "두 사람이 이젠 두 번 다시"
db NewLine
.stringn  "못 만날 것 같은 느낌이 들어요・・・"
db NewLine
db WaitForA
db ScrollText
...
.stringn  "브리기드 언니!"
db NewLine
.stringn  "저예요, 여동생 에딘이에요!"
db WaitForA
db ScrollText

.stringn  "부디 기억해 내 주세요"
db NewLine
...
.stringn  "응, 괜찮지?"
db NewLine
.stringn  "너랑은 소꿉친구기도 하고"
db NewLine
db WaitForA
db ScrollText

.stringn  "이런 얘기를 할 사람이"
db NewLine
.stringn  "아젤밖에 없는걸"
db NewLine
...
db WaitForA
dh ScrollText_DBC
.stringn  "그냥 어떻게 대하면 좋을지"
db NewLine
.stringn  "모르니까 곤란해하는 거라 생각해"
db NewLine
db WaitForA
db ScrollText

.stringn  "뭐, 조만간 괜찮아질 테니까"
db NewLine
.stringn  "신경 쓰지 마"
db NewLine
db WaitForA
...
.stringn  "에딘이"
db NewLine
.stringn  "내 아내가 되어 주다니,"
db NewLine
.stringn  "왠지 꿈을 꾸는 기분이야"
db WaitForA
db ScrollText
...
db WaitForA
dh ScrollText_DBC
.stringn  "제 누이동생도 살아 있다면"
db NewLine
.stringn  "당신 정도의 나이가 됐겠지요"
db NewLine
.stringn  "남 일 같지가 않네요"
db WaitForA
db ScrollText
...
dh PauseForTime
db 0x10
.stringn  "그렇게 자신을 책망하지 마"
db NewLine
.stringn  "마냐의 죽음을 헛되이 하지 않으려면"
db NewLine
.stringn  "어머님을 지켜 드려야 해"
db WaitForA
...
db NewLine
.stringn  "저도 머지않아 죽게 되겠지요"
db NewLine
.stringn  "그러니 이걸 맡기는 겁니다"
...
.stringn  "더욱 완전한 존재로서 형상을 얻죠"
db NewLine
.stringn  "죽는 것을 두려워해선 안 됩니다"
db NewLine
.stringn  "잃는 것을 두려워하지 마세요"
...
dh PauseForTime
db 0x10
.stringn  "그럴 수가・・・ 너무해요 클로드 님"
db NewLine
.stringn  "저 혼자만 살아남으라는 건가요!?"
db NewLine
db WaitForA
...
db Top_Slot// Tailtiu
.stringn  "클로드 님, 저 어쩌면 좋아요?"
db NewLine

db Bottom_Slot// Claud
dh PauseForTime
db 0x10
.stringn  "당신이 프리지군과 어떻게 싸우겠어요"
db NewLine
.stringn  "아버지와 싸우다니 말도 안 됩니다"
db NewLine
db WaitForA
dh ScrollText_DBC
...
db Top_Slot// Ayra
.stringn  "렉스, 드디어 마지막이구나"
db NewLine

db Bottom_Slot// Lex
dh PauseForTime
db 0x10
.stringn  "그래・・・ 근데 너도 참 고집 세다"
db NewLine
.stringn  "정말 이자크로 안 갈 거야?"
db NewLine
db WaitForA
...
db Top_Slot// Ayra
dh ScrollText_DBC
.stringn  "그러니 같이 데리러 가자는 거다"
db NewLine
.stringn  "물론 이 전쟁이 끝난 뒤의 얘기지만"
db NewLine

db Bottom_Slot// Lex
dh PauseForTime
db 0x10
.stringn  "그러자고 아이라, 그럼 가 볼까!"
db NewLine
db WaitForA
...
db Top_Slot// Ayra
dh ScrollText_DBC
.stringn  "호린은 왜 나를 지켜 주는 거지?"
db NewLine
.stringn  "뭔가 이유가 있는 것 아닌가?"
db NewLine

db Bottom_Slot// Chulainn
dh PauseForTime
db 0x10
.stringn  "난 너를 어릴 적부터 알고 있었어"
db NewLine
...
dh PauseForTime
db 0x10
.stringn  "난 소파라 영주의 아들"
db NewLine
.stringn  "그리고 한 아름다운 소녀에게 반한"
db NewLine
.stringn  "바보 같은 남자다・・・"
db WaitForA
db EndText
...
.stringn  "난 다 알아"
db NewLine
.stringn  "아이라보다 귀여운 여자는 없다고"
db NewLine
db WaitForA

db Top_Slot// Ayra
dh ScrollText_DBC
.stringn  "대체 뭐냐 아단, 열이라도 있나?"
db NewLine
...
db Top_Slot// Brigid
.stringn  "알렉, 이제 곧 발할라야"
db NewLine

db Bottom_Slot// Alec
dh PauseForTime
db 0x10
.stringn  "그래, 드디어 조국에 돌아왔어"
db NewLine
db WaitForA

db Top_Slot// Brigid
dh ScrollText_DBC
.stringn  "나도 태어난 나라로 돌아갈 수 있겠지"
db NewLine
.stringn  "잉그비・・・ 어떤 곳일까"
db NewLine
...
db Top_Slot// Brigid
dh ScrollText_DBC
.stringn  "응, 당신이 곁에 있으니까・・・"
db NewLine

db Bottom_Slot// Jamke
dh PauseForTime
db 0x10
.stringn  "사실 브리기드는 안 싸웠으면 하는데"
db NewLine
.stringn  "역시 안 되겠지?"
db NewLine
db WaitForA
