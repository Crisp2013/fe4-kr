...
org $400000
incbin image_msu/pcx/intro.col	//팔레트 생성 파일(*.col) 위치 지정
...
org $400200
incbin image_msu/pcx/intro.map	//타일맵 생성 파일(*.map) 위치 지정
...
org $410000
incbin image_msu/pcx/intro.set	//이미지 생성 파일(*.set) 위치 지정
